            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    while($data=mysql_fetch_array($datamasjid)){
                        ...
                        $remaja=$data['remaja'];
                        $notelp=$data['no_telp'];
                        $ketmasjid=$data['ket_masjid'];
                    }
                    ?>
                    <div class="col-lg-6">
                        <form role="form" action="http://simas-jabar.web.id/proses/input_data_masjid.php" method="POST">
                            <div class="form-group">
                                <label>Nama Masjid</label>
                                <input type="text" class="form-control" name="namamasjid" required minlength="3" maxlength="40">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="telpmasjid" required type="number" rangelength="[11,12]">
                            </div>
                            <div class="form-group">
                                <label>Tema Masjid</label>
                                <textarea class="form-control" rows="5" name="temamasjid" required minlength="3" > </textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" name="alamatmasjid" required minlength="3" maxlength="150" > </textarea>
                            </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>Tahun Berdiri</label>
                            <input class="form-control" name="tahunberdiri" required type="number" rangelength="[1,10]">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="jumlahimam" required type="number" rangelength="[1,10]">
                        </div>
                        <div class="form-group">
                            <label>Jumlah Khotib Aktif</label>
                            <input class="form-control" name="jumlahkhotib" required type="number" rangelength="[1,10]">
                        </div>
                        <div class="form-group">
                            <label>Jumlah Muazin Aktif</label>
                            <input class="form-control" name="jumlahmuazin" required type="number" rangelength="[1,10]" >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="luastanah" required type="number" rangelength="[1,10]">
                        </div>
                        <div class="form-group">
                            <label>Status Tanah</label>
                            <input type="text" class="form-control" name="statustanah" required maxlength="25" minlength="3">
                        </div>
                        <div class="form-group">
                            <label>Luas Bangunan</label>
                            <input class="form-control" name="luasbangunan" required type="number" rangelength="[1,10]">
                        </div>
                        <div class="form-group">
                            <label>Keterangan Masjid</label>
                            <textarea class="form-control" rows="3" name="ketmasjid" required minlength="3" maxlength="150"> </textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            ...
                            <button type="submit" class="btn btn-success" name="updatemasjid">INSERT Data Masjid</button>
