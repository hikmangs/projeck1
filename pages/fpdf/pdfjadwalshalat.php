...
$sql=mysql_query("SELECT * FROM tabel_jadwal_shalat ORDER BY id_jadwal_shalat");
$data = array();
...
$judul = "JADWAL SHALAT ".$nama1;
$header = array(
array("label"=>"ID", "length"=>15, "align"=>"L"),
array("label"=>"Tanggal Shalat", "length"=>25, "align"=>"L"),
array("label"=>"IMAM", "length"=>50, "align"=>"L"),
array("label"=>"Ket Shalat", "length"=>30, "align"=>"L"),
array("label"=>"Waktu Shalat", "length"=>25, "align"=>"L"),
array("label"=>"KHOTIB", "length"=>45, "align"=>"L"),
array("label"=>"MUAZIN", "length"=>45, "align"=>"L"),
array("label"=>"Tema", "length"=>45, "align"=>"L"),
);
