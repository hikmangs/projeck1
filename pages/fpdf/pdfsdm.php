...
$sql=mysql_query("SELECT * FROM tabel_sdm ORDER BY id_sdm");
$data = array();
...
$judul = "DATA SDM ".$nama1;
$header = array(
array("label"=>"ID", "length"=>15, "align"=>"L"),
array("label"=>"Nama SDM", "length"=>50, "align"=>"L"),
array("label"=>"Status", "length"=>20, "align"=>"L"),
array("label"=>"No.HP SDM", "length"=>30, "align"=>"L"),
array("label"=>"Alamat", "length"=>150, "align"=>"L"),
);
