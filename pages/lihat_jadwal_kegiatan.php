                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php
                                     $results = mysql_query("SELECT * FROM tabel_jadwal_kegiatan");
                                     $i=1;
                                    while($data=mysql_fetch_array($results)){
                                        ...
                                        echo "<td>".$data['ket_kegiatan']."</td>";
                                        echo "<td><a href='proses/hapus_jadwal_kegiatan.php?id_kegiatan=".$data['id_jadwal_kegiatan']."'><i class='fa fa-trash-o
 fa-2x'></i></a></td>";
                                        echo "</tr>";
                                    }
                                    ?>
