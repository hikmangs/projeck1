...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Update Data Masjid To Server</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<?php
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="row">
                    ...
                    ?>
                    <div class="col-lg-6">
                        <form role="form" action="http://simas-jabar.web.id/proses/input_data_masjid.php" method="POST" enctype="multipart/form-data">
