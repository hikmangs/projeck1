...
<head>
    ...
    <title>SIMAS JABAR SERVER</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">SIMAS JABAR SERVER</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Jadwal Kegiatan</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
             <?php
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="dataTables-example">
                                    ...
                                    while($data=mysql_fetch_array($results)){
                                        ...
                                        echo "<td>".$data['ket_keg']."</td>";
                                        echo "<td><a href='http://www.simas-jabar.web.id/proses/insert_jadwal_kegiatan.php?id_kegiatan=".$data['id_kegiatan']."&namakegiatan=".$data['nama_kegiatan']."&tgl_kegiatan=".$data['tgl_kegiatan']."&namapemateri=".$data['pemateri']."&waktukegiatan=".$data['waktu_kegiatan']."&lokasi=".$data['tempat_kegiatan']."&ket_keg=".$data['tempat_kegiatan']."'><i class='glyphicon glyphicon-upload'> Update</i></a></td>";
                                        echo "</tr>";
                                    }
                                    ?>
